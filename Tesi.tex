...
\usepackage[english,italian]{babel}   %Pacchetto per la sillabazione delle parole
                                      %in italiano e in inglese

%\usepackage[Sonny]{fncychap}         %Pacchetto per avere diversi tipi di titoli di
                                      %capitolo diversi. Commentare se si desidera
                                      %avere i titoli in maniera normale. Gli stili
                                      %possibili sono 2: Sonny, Lenny
...
\usepackage{epstopdf} %per utilizzare eps nel file
...
\usepackage[]{xfrac} %pacchetto per frazioni obblique
...
\input{tex/Dedica.tex}

\setcounter{tocdepth}{2} 			 %Profondità indice
\setcounter{secnumdepth}{3}

\pagenumbering{Roman}                   %serve per mettere i numeri romani
\input{tex/Sommario.tex}
%\printglossaries

\input{tex/Indice.tex}               % non deve essere presente nell'indice
%\input{tex/Terminologia.tex}
...
\input{tex/Fluidodinamica.tex}
\input{tex/Foamer.tex}
\input{tex/ImpiantiNUOVAPROPOSTA.tex}
\input{tex/Piggaggio.tex}
\input{tex/Test.tex}
