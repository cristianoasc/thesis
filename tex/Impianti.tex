...
Il gas naturale è una miscela di idrocarburi solitamente allo stato gassoso. Il gas naturale è costituito in gran parte da metano e da idrocarburi più pesanti. Assieme agli idrocarburi, il gas naturale presenta spesso molti componenti come acqua, anidride carbonica, azoto, idrogeno solforato e solfati, in alcuni casi anche elio e metalli pesanti come mercurio. In \tabref{tab:ng-composition} è riportato un esempio di composizione centesimale di un gas naturale. 
...
\paragraph{Punto di rugiada in acqua e in idrocarburi}
...
Prima dell'immissione del TEG ricco viene convogliato in una camera di flash o \textit{flash drum}, nel quale i gas associati vengono recuperati tramite espansione a bassa pressione e recuperati alla testa del separatore. \\
...
Altri trattamenti che il gas naturale può subire sono il lavaggio del gas di coda, assorbimento fisico, la rimozione di \ce{H2S} tramite processi ossidativi, filtri a carboni attivi.
